...
import { getAccount } from '@/libs/AppWriteClient';
  ...
  useEffect(() => {
    const handleGitHubCallback = async () => {
      ...
      try {
        ...
        console.log('GitHub OAuth session created:', session);
      ...
      <div className="flex flex-col items-center justify-center min-h-screen px-4">
        <div className="w-full max-w-md p-8 space-y-8 bg-white dark:bg-gray-900 rounded-lg shadow-md">
          <div className="text-center">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">GitHub Authentication</h1>
